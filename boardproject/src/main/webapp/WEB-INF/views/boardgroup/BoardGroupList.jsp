...
<title>board</title>
<link rel="stylesheet" href="${contextPath}/js/dynatree/ui.dynatree.css" id="skinSheet"/>
<script src="${contextPath}/js/jquery-3.4.1.min.js"></script>

<script src="js/jquery-ui.js"></script>
<script src="${contextPath}/js/dynatree/jquery.dynatree.js"></script>
...
<body>
	<input type="hidden" id="dynatreedata" value='${treeStr }' >
